...
const (
	...
	ActorService_GetByMovieID_FullMethodName               = "/actor.service.actor.ActorService/GetByMovieID"
...
func (c *actorServiceClient) GetByMovieID(ctx context.Context, in *GetByMovieIDRequest, opts ...grpc.CallOption) (*GetByMovieIDResponse, error) {
	out := new(GetByMovieIDResponse)
	err := c.cc.Invoke(ctx, ActorService_GetByMovieID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedActorServiceServer) GetByMovieID(context.Context, *GetByMovieIDRequest) (*GetByMovieIDResponse, error) {
...
func _ActorService_GetByMovieID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetByMovieIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ActorServiceServer).GetByMovieID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ActorService_GetByMovieID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ActorServiceServer).GetByMovieID(ctx, req.(*GetByMovieIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ActorService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ActorService_GetByMovieID_Handler,
		},
		{
